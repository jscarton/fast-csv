...
describe('CsvParserStream', function () {
    ...
    var expectErrorEvent = function (stream, message, resolve, reject) {
        ...
        stream
            ...
            .on('end', function () { return reject(new Error("Expected and error to occur [expectedMessage=" + message + "]")); });
    };
    var parseContentAndCollect = function (data, options) {
        if (options === void 0) { options = {}; }
        return __fixtures__1.parseContentAndCollectFromStream(data, createParserStream(options));
    };
    it('should parse a csv without quotes or escapes', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true }), __fixtures__1.withHeaders.parsed);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, objectMode: false }), expected)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should emit data as an object if objectMode is true', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, objectMode: true }), __fixtures__1.withHeaders.parsed);
    });
    it('should emit data as an object if objectMode is not specified', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true }), __fixtures__1.withHeaders.parsed);
    });
    it('should parse a csv with quotes', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndQuotes, { headers: true }), __fixtures__1.withHeadersAndQuotes.parsed);
    });
    it('should parse a csv with without headers', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.noHeadersAndQuotes), __fixtures__1.noHeadersAndQuotes.parsed);
    });
    it("should parse a csv with ' escapes", function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndAlternateQuote, { headers: true, quote: "'" }), __fixtures__1.withHeadersAndAlternateQuote.parsed);
    });
    describe('headers option', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.noHeadersAndQuotes, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndQuotes, { headers: transform }), expected)];
                    case 1:
                        _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndQuotes, {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            transform = jest.fn().mockReturnValue(['firstName', 'lastName', 'emailAddress', 'address']);
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndQuotes, { headers: transform, renameHeaders: true }), expected)];
                        case 1:
                            _a.sent();
                            expect(transform).toHaveBeenCalledTimes(1);
                            expect(transform).toHaveBeenCalledWith(['first_name', 'last_name', 'email_address', 'address']);
        ...
        it('should discard extra columns that do not map to a header when discardUnmappedColumns is true', function () {
            return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.headerColumnMismatch, { headers: true, discardUnmappedColumns: true }), __fixtures__1.headerColumnMismatch.parsed);
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndMissingColumns, {
                                headers: true,
    ...
    it('should parse data with an alternate encoding', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.alternateEncoding, { headers: true, encoding: 'utf16le' }), __fixtures__1.alternateEncoding.parsed);
    });
    it('should handle a trailing comma', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.trailingComma, { headers: true }), __fixtures__1.trailingComma.parsed);
    });
    it('should skip valid, but empty rows when ignoreEmpty is true', function () {
        return __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.emptyRows, { headers: true, ignoreEmpty: true }), []);
    });
    describe('alternate delimiters', function () {
        ['\t', '|', ';'].forEach(function (delimiter) {
            it("should support '" + delimiter.replace(/\t/, '\\t') + "' delimiters", function () { return __awaiter(void 0, void 0, void 0, function () {
                var asset;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            asset = __fixtures__1.withHeadersAlternateDelimiter(delimiter);
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(asset, { headers: true, delimiter: delimiter }), asset.parsed)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        it('should parse up to the specified number of maxRows', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        maxRows = 3;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, maxRows: maxRows }), __fixtures__1.withHeaders.parsed.slice(0, maxRows))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should parse all rows if maxRows === 0', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        maxRows = 0;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, maxRows: maxRows }), __fixtures__1.withHeaders.parsed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should skip up to the specified number of rows using the first non-skipped line as headers', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        linesToSkip = 2;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeadersAndSkippedLines, { headers: true, skipLines: linesToSkip }), __fixtures__1.withHeadersAndSkippedLines.parsed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should skip up to the specified number of rows not withoutHeaders', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        linesToSkip = 2;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.skipLines, { skipLines: linesToSkip }), __fixtures__1.skipLines.parsed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeadersAndSkippedLines, parser), expected)];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = lodash_partition_1.default(nonSkippedRows, validator), expected = _a[0], invalid = _a[1];
                            validatedRows = [];
                            parser = createParserStream({ headers: true, skipLines: linesToSkip }).validate(validator);
                            return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeadersAndSkippedLines, parser), expected, invalid)];
                        case 1:
                            _b.sent();
        ...
        it('should parse all rows if maxRows === 0', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        linesToSkip = 0;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, skipLines: linesToSkip }), __fixtures__1.withHeaders.parsed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            it('should skip up to the specified number of rows not including the header row in the count', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            skipRows = 3;
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, skipRows: skipRows }), __fixtures__1.withHeaders.parsed.slice(skipRows))];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, {
                                    headers: ['h1', 'h2', 'h3'],
                                    renameHeaders: true,
                                    skipRows: skipRows,
                                }), expected)];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.noHeadersAndQuotes, { skipRows: skipRows }), expected)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.noHeadersAndQuotes, { headers: ['h1', 'h2', 'h3', 'h4'], skipRows: skipRows }), expected)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeaders, parser), expected)];
                        case 1:
                            _a.sent();
                            expect(transformedRows).toEqual(expected);
                            return [2 /*return*/];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeaders, parser), expected, invalid)];
                        case 1:
                            _b.sent();
                            expect(validatedRows).toEqual(nonSkippedRows);
                            return [2 /*return*/];
        ...
        it('should parse all rows if maxRows === 0', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        skipRows = 0;
                        return [4 /*yield*/, __fixtures__1.expectParsed(parseContentAndCollect(__fixtures__1.withHeaders, { headers: true, skipRows: skipRows }), __fixtures__1.withHeaders.parsed)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should emit an error for malformed rows', function () {
        return new Promise(function (res, rej) {
            __fixtures__1.write(__fixtures__1.malformed);
            var stream = src_1.parseFile(__fixtures__1.malformed.path, { headers: true });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeaders, stream), __fixtures__1.withHeaders.parsed)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeaders, stream), __fixtures__1.withHeaders.parsed.map(function (r) { return ({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.noHeadersAndQuotes, stream), expected)];
                    case 1:
                        _a.sent();
                        expect(eventCount).toBe(1);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.noHeadersAndQuotes, stream), __fixtures__1.noHeadersAndQuotes.parsed)];
                    case 1:
                        _a.sent();
    ...
    describe('#validate', function () {
        ...
        it('should allow validation of rows', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = lodash_partition_1.default(__fixtures__1.withHeaders.parsed, syncValidator), valid = _a[0], invalid = _a[1];
                        parser = createParserStream({ headers: true }).validate(syncValidator);
                        return [4 /*yield*/, __fixtures__1.expectParsed(__fixtures__1.parseContentAndCollectFromStream(__fixtures__1.withHeaders, parser), valid, invalid)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = lodash_partition_1.default(__fixtures__1.withHeaders.parsed, validator), valid = _a[0], invalid = _a[1];
        ...
        it('should propagate errors from async validation', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var index = -1;
        ...
        it('should propagate async errors at the beginning', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var stream = src_1.parseFile(__fixtures__1.withHeaders.path, {
                    headers: true,
        ...
        it('should propagate thrown errors', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var index = -1;
                var stream = src_1.parseFile(__fixtures__1.withHeaders.path, { headers: true }).validate(function (data, validateNext) {
                    index += 1;
                    if (index === 8) {
        ...
        it('should propagate thrown errors at the beginning', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var stream = src_1.parseFile(__fixtures__1.withHeaders.path, { headers: true }).validate(function () {
                    throw new Error('Validation ERROR!!!!');
                });
                expectErrorEvent(stream, 'Validation ERROR!!!!', res, rej);
            });
    ...
    describe('#transform', function () {
        ...
        it('should propogate errors when transformation of data', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var index = -1;
                var stream = src_1.parseFile(__fixtures__1.withHeaders.path, { headers: true }).transform(function (data, cb) {
        ...
        it('should propagate thrown errors at the beginning', function () {
            return new Promise(function (res, rej) {
                __fixtures__1.write(__fixtures__1.withHeaders);
                var stream = src_1.parseFile(__fixtures__1.withHeaders.path, { headers: true }).transform(function () {
                    throw new Error('transformation ERROR!!!!');
                });
                expectErrorEvent(stream, 'transformation ERROR!!!!', res, rej);
            });
...
//# sourceMappingURL=CsvParsingStream.spec.js.map