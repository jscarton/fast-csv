...
var os_1 = require("os");
exports.withHeadersAlternateDelimiter = function (delimiter) {
    if (delimiter === void 0) { delimiter = '\t'; }
    return ({
        path: path_1.resolve(__dirname, 'tmp', 'with_headers_alternate_delimiter.tsv'),
        content: [
...
//# sourceMappingURL=withHeadersAlternateDelimiter.js.map