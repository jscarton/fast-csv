...
var FieldFormatter = /** @class */ (function () {
    function FieldFormatter(formatterOptions) {
        ...
        var escapePattern = "[" + formatterOptions.delimiter + lodash_escaperegexp_1.default(formatterOptions.rowDelimiter) + "|\r|\n]";
    ...
    FieldFormatter.prototype.format = function (field, fieldIndex, isHeader) {
        var preparedField = ("" + (lodash_isnil_1.default(field) ? '' : field)).replace(/\0/g, '');
