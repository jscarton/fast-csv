...
describe('.writeToString', function () {
    it('should write an array of arrays', function () {
        return expect(src_1.writeToString(__fixtures__1.arrayRows, { headers: true })).resolves.toEqual('a,b\na1,b1\na2,b2');
    });
    it('should support transforming an array of arrays', function () {
        return expect(src_1.writeToString(__fixtures__1.arrayRows, {
            headers: true,
    ...
    it('should write an array of multi-dimensional arrays', function () {
        return expect(src_1.writeToString(__fixtures__1.multiDimensionalRows, { headers: true })).resolves.toEqual('a,b\na1,b1\na2,b2');
    });
    it('should support transforming an array of multi-dimensional arrays', function () {
        return expect(src_1.writeToString(__fixtures__1.multiDimensionalRows, {
            headers: true,
            transform: function (row) {
    ...
    it('should write an array of objects', function () {
        return expect(src_1.writeToString(__fixtures__1.objectRows, {
            headers: true,
            transform: function (row) {
                return {
                    A: row.a,
    ...
    describe('header option', function () {
        it('should write an array of objects without headers', function () {
            return expect(src_1.writeToString(__fixtures__1.objectRows, { headers: false })).resolves.toEqual('a1,b1\na2,b2');
        });
        it('should write an array of objects with headers', function () {
            return expect(src_1.writeToString(__fixtures__1.objectRows, { headers: true })).resolves.toEqual('a,b\na1,b1\na2,b2');
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(src_1.writeToString(rows, { headers: false })).resolves.toEqual('a1,b1\na2,b2')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should write an array of multi-dimensional arrays without headers', function () {
            return expect(src_1.writeToString(__fixtures__1.multiDimensionalRows, { headers: false })).resolves.toEqual('a1,b1\na2,b2');
        });
    ...
    describe('rowDelimiter option', function () {
        it('should support specifying an alternate row delimiter', function () {
            return expect(src_1.writeToString(__fixtures__1.objectRows, { headers: true, rowDelimiter: '\r\n' })).resolves.toEqual('a,b\r\na1,b1\r\na2,b2');
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(src_1.writeToString(rows, { headers: true, rowDelimiter: '\t' })).resolves.toEqual('a,b\t"a\t1",b1\t"a\t2",b2')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should add a final rowDelimiter if includeEndRowDelimiter is true', function () {
        return expect(src_1.writeToString(__fixtures__1.objectRows, { headers: true, includeEndRowDelimiter: true })).resolves.toEqual('a,b\na1,b1\na2,b2\n');
    });
});
describe('.writeToBuffer', function () {
    it('should write an array of arrays', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.arrayRows, { headers: true })).resolves.toEqual(Buffer.from('a,b\na1,b1\na2,b2'));
    });
    it('should support transforming an array of arrays', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.arrayRows, {
            headers: true,
            transform: function (row) {
                return row.map(function (entry) { return entry.toUpperCase(); });
            },
    ...
    it('should write an array of multi-dimensional arrays', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.multiDimensionalRows, { headers: true })).resolves.toEqual(Buffer.from('a,b\na1,b1\na2,b2'));
    });
    it('should support transforming an array of multi-dimensional arrays', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.multiDimensionalRows, {
            headers: true,
            transform: function (row) {
                return row.map(function (col) { return [col[0], col[1].toUpperCase()]; });
            },
    ...
    it('should write an array of objects', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.objectRows, {
            headers: true,
            transform: function (row) {
                return {
                    A: row.a,
    ...
    describe('header option', function () {
        it('should write an array of objects without headers', function () {
            return expect(src_1.writeToBuffer(__fixtures__1.objectRows, { headers: false })).resolves.toEqual(Buffer.from('a1,b1\na2,b2'));
        });
        it('should write an array of objects with headers', function () {
            return expect(src_1.writeToBuffer(__fixtures__1.objectRows, { headers: true })).resolves.toEqual(Buffer.from('a,b\na1,b1\na2,b2'));
        });
        it('should write an array of arrays without headers', function () { return __awaiter(void 0, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(src_1.writeToBuffer(rows, { headers: false })).resolves.toEqual(Buffer.from('a1,b1\na2,b2'))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should write an array of multi-dimensional arrays without headers', function () {
            return expect(src_1.writeToBuffer(__fixtures__1.multiDimensionalRows, { headers: false })).resolves.toEqual(Buffer.from('a1,b1\na2,b2'));
        });
        it('should write an array of multi-dimensional arrays with headers', function () {
            return expect(src_1.writeToBuffer(__fixtures__1.multiDimensionalRows, { headers: true })).resolves.toEqual(Buffer.from('a,b\na1,b1\na2,b2'));
        });
    ...
    describe('rowDelimiter option', function () {
        it('should support specifying an alternate row delimiter', function () {
            return expect(src_1.writeToBuffer(__fixtures__1.objectRows, { headers: true, rowDelimiter: '\r\n' })).resolves.toEqual(Buffer.from('a,b\r\na1,b1\r\na2,b2'));
        });
        it('should escape values that contain the alternate row delimiter', function () { return __awaiter(void 0, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(src_1.writeToBuffer(rows, { headers: true, rowDelimiter: '\t' })).resolves.toEqual(Buffer.from('a,b\t"a\t1",b1\t"a\t2",b2'))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should add a final rowDelimiter if includeEndRowDelimiter is true', function () {
        return expect(src_1.writeToBuffer(__fixtures__1.objectRows, { headers: true, includeEndRowDelimiter: true })).resolves.toEqual(Buffer.from('a,b\na1,b1\na2,b2\n'));
    });
});
